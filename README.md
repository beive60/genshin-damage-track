...
DPS計測かかし++（Kosmos氏投稿、ステージGUID：13031458938）の動画ファイルを入力として、DPSの時間変化を分析・可視化します。主な機能は以下の通りです:
...
- OS: Windows 11
- DPS計測かかし++（ステージGUID：13031458938）: 2026年1月14日投稿版
...
| --- | --- | --- |
| `--dps-interval` | DPS 平均化区間（サンプル数）。1 = 瞬間 DPS  | `1` |
| `--plot`, `-p` | グラフをウィンドウで表示する（`--plot-output` 指定時にも表示したい場合に使用） | ― |
| `--plot-output` | グラフの PNG 出力先パス（指定時はデフォルトのウィンドウ表示をスキップ） | ― |
...
```csv
timestamp_sec,total_damage,delta_damage,dps,char_0_total_damage,char_0_delta_damage,char_0_dps,char_0_pct,char_1_total_damage,char_1_delta_damage,char_1_dps,char_1_pct,char_2_total_damage,char_2_delta_damage,char_2_dps,char_2_pct,char_3_total_damage,char_3_delta_damage,char_3_dps,char_3_pct
1.0,433863,109829,109829.00,869,869,219.98,0.2,187858,54510,47554.77,43.3,199344,36598,50462.36,45.9,45792,17852,11591.88,10.6
2.0,614104,180241,180241.00,24755,23886,7265.65,4.0,234173,46315,68730.34,38.1,298674,99330,87661.54,48.6,56502,10710,16583.47,9.2
```
